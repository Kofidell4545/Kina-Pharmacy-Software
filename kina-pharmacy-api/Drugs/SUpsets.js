const stomachUpsetsData = [
    {
        ...
        images: [
            "http://localhost:8000/assets/DrugImages/Nugel0.jpg",
            "http://localhost:8000/assets/DrugImages/Nugel1.jpeg",
        ],
        inStock: true,
        price: "GHS 70.00",
        uses: [
    ...
    },
    {
        ...
        images: [
            "http://localhost:8000/assets/DrugImages/Magacid0.avif",
            "http://localhost:8000/assets/DrugImages/Magacid1.webp",
            "http://localhost:8000/assets/DrugImages/Magacid2.jpg",
        ],
        inStock: true,
        price: "GHS 23.00",
        uses: [
    ...
    },
    {
        ...
        images: [
            "http://localhost:8000/assets/DrugImages/Gastrogen0.jpg",
            "http://localhost:8000/assets/DrugImages/Gastrogen1.jpg",
        ],
        inStock: true,
        price: "GHS 25.00",
        uses: [
    ...
    },
    {
        ...
        images: [
            "http://localhost:8000/assets/DrugImages/MoM0.avif",
            "http://localhost:8000/assets/DrugImages/MoM1.jpg",
            "http://localhost:8000/assets/DrugImages/MoM2.jpg",
        ],
        inStock: true,
        price: "GHS 29.00",
        uses: [
    ...
    },
    {
        ...
        images: [
            "http://localhost:8000/assets/DrugImages/Omeprazol0.jpg",
            "http://localhost:8000/assets/DrugImages/Omeprazol1.png",
        ],
        inStock: true,
        price: "GHS 6.00",
        uses: [
