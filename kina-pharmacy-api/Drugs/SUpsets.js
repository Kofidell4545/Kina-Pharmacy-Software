const stomachUpsetsData = [
    {
        ...
        images: [
            "../assets/DrugImages/Nugel0.jpg",
            "../assets/DrugImages/Nugel1.jpeg",
        ],
        inStock: true,
        price: "GHS 70.00",
        uses: [
    ...
    },
    {
        ...
        images: [
            "../assets/DrugImages/Magacid0.avif",
            "../assets/DrugImages/Magacid1.webp",
            "../assets/DrugImages/Magacid2.jpg",
        ],
        inStock: true,
        price: "GHS 23.00",
        uses: [
    ...
    },
    {
        ...
        images: [
            "../assets/DrugImages/Gastrogen0.jpg",
            "../assets/DrugImages/Gastrogen1.jpg",
        ],
        inStock: true,
        price: "GHS 25.00",
        uses: [
    ...
    },
    {
        ...
        images: [
            "../assets/DrugImages/MoM0.avif",
            "../assets/DrugImages/MoM1.jpg",
            "../assets/DrugImages/MoM2.jpg",
        ],
        inStock: true,
        price: "GHS 29.00",
        uses: [
    ...
    },
    {
        ...
        images: [
            "../assets/DrugImages/Omeprazol0.jpg",
            "../assets/DrugImages/Omeprazol1.png",
        ],
        inStock: true,
        price: "GHS 6.00",
        uses: [
